...
export const metadata: Metadata = {
  title: {
    template:
      "%s | 橘香堂(worx mt.fuji) - 富士市吉原のコワーキングスペース・多目的スペース",
    default:
      "橘香堂(worx mt.fuji) | 富士市吉原のコワーキングスペース・多目的スペース",
  },
  description:
    "富士市吉原の多目的レンタルスペース「橘香堂」。コワーキング、ヨガ・ダンススタジオ、ギャラリー展示、マルシェ開催など様々な用途でご利用可能です。富士駅から車で5分。",
  keywords: [
    "富士市　レンタルスペース",
    "富士市　コワーキング",
    "富士市　住所登録",
  ...
  openGraph: {
    title:
      "橘香堂(worx mt.fuji) | 富士市吉原の多目的レンタルスペース・コワーキングスペース",
    description:
      "富士市吉原の多目的レンタルスペース。ヨガ・ダンススタジオ、ギャラリー、マルシェ会場、コワーキングスペースとして利用可能です。印刷設備・住所登録サービス完備。",
